...
#         <h1>🌦 Smart Weather Monitoring Panel</h1>
#         <p style="font-size:18px;">
#             Real-time weather insights for smart farming and crop protection.
#         </p>
#     </div>
#     """, unsafe_allow_html=True)
...
#     data = get_weather_by_coordinates(
#         latitude,
#         longitude
#     )
...
#     st.markdown(
#         '<div class="section-title">🌤 Live Weather Conditions</div>',
#         unsafe_allow_html=True
#     )
...
#         st.markdown(f"""
#         <div class="metric-card">
#             <div class="metric-title">🌱 Soil Temperature</div>
...
#     st.markdown(
#         '<div class="section-title">🤖 AI Agricultural Insights</div>',
#         unsafe_allow_html=True
#     )
...
#         st.warning(
#             "🌧 Heavy rain expected. Delay pesticide spraying and harvesting."
#         )
#         insight_found = True
...
#     st.caption(
#         "Powered by Open-Meteo API • Real-time AI Smart Agriculture Monitoring"
#     )
